...
import { VideoGridCard, VideoGridCardSkeleton } from "@/modules/videos/ui/components/video-grip-card";
...
const SubscribedVideosSectionSkeleton = () => {
    return (
        ...
        xl:grid-cols-3 2xl:grid-cols-4 [@media(min-width:1920px)]:grid-cols-5
